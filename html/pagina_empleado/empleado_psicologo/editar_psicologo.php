<!-- KM = Editar persona de apoyo (psicólogo) -->
...
<body>
    ...
    <main class="contenedor-editar">
        <section class="panel-editar">
            ...
            <form id="formEditar" action="../../../src/auth/editar_persona_psicologo.php" method="POST" enctype="multipart/form-data">
                ...
                <a class="btn-glow" href="inicio_empleado_psicologo.php">Volver</a>
            </form>
        </section>
    </main>

    <!-- Modal de imágenes de perfil del psicólogo -->
    <div id="modalImagen" class="modal" style="display: none;">
        <div class="modal-contenido">
            ...
            <div class="imagenes-opciones">
                <img src="../../../iconos/iconos_perfil/icono_psico_1.png" onclick="seleccionarImagen(this, 'icono_psico_1.png')">
                <img src="../../../iconos/iconos_perfil/icono_psico_2.png" onclick="seleccionarImagen(this, 'icono_psico_2.png')">
                <img src="../../../iconos/iconos_perfil/icono_spico_3.png" onclick="seleccionarImagen(this, 'icono_spico_3.png')">
            </div>
