<!-- KM = Editar persona de apoyo (consultor legal) -->
...
<body>
    ...
    <main class="contenedor-editar">
        <section class="panel-editar">
            ...
            <!-- KM = Formulario de edición -->
            <form id="formEditar" action="../../../src/auth/editar_persona_consultor.php" method="POST" enctype="multipart/form-data">
                ...
                <a class="btn-glow" href="inicio_empleado_consultor.php">Volver</a>
            </form>
        </section>
    </main>

    <!-- Modal de imágenes de perfil del consultor -->
    <div id="modalImagen" class="modal" style="display: none;">
        <div class="modal-contenido">
            ...
            <div class="imagenes-opciones">
                <img src="../../../iconos/iconos_perfil/icono_legal_1.png" onclick="seleccionarImagen(this, 'icono_legal_1.png')">
                <img src="../../../iconos/iconos_perfil/icono_legal_2.png" onclick="seleccionarImagen(this, 'icono_legal_2.png')">
                <img src="../../../iconos/iconos_perfil/icono_legal_3.png" onclick="seleccionarImagen(this, 'icono_legal_3.png')">
            </div>
            <button type="button" class="boton-mai" onclick="confirmarImagen()">Aceptar</button>
        </div>
    </div>

    <!-- KM = JS para editar persona de apoyo -->
