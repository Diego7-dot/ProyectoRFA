<!-- KM = Editar persona de apoyo (enfermería) -->
<?php require_once("../../../src/auth/consultar_perfil_apoyo.php"); ?>

<!DOCTYPE html>
<html lang="es">

<head>
    <!-- KM = Configuraciones básicas del documento -->
    <meta charset="UTF-8">
    <meta name="viewport" content="width=device-width, initial-scale=1.0">
    <link href="../../../iconos/pagina_principal/logo_fem_icon.png" rel="icon">
    <title>Editar perfil</title>
    <!-- KM = Enlace a hoja de estilos -->
    <link rel="stylesheet" href="../../../css/pagina_usuario/estilo_editar_usuario.css">
</head>

<body>
    <!-- KM = Mensaje flotante de proceso en curso -->
    <div id="mensaje-proceso" class="mensaje-proceso"></div>

    <!-- KM = Botón de modo oscuro -->
    ...
    <main class="contenedor-editar">
        <section class="panel-editar">
            ...
            <!-- KM = Formulario de edición de perfil -->
            <form id="formEditar" action="../../../src/auth/editar_persona_enfermero.php" method="POST" enctype="multipart/form-data">

                <!-- KM = Documento (solo lectura) -->
                <div class="campo">
                ...
                <div class="campo">
                    ...
                    <input type="text" name="telApo" id="telApo" value="<?= htmlspecialchars($telefono) ?>" pattern="\d{7,11}" maxlength="11" title="El teléfono debe tener entre 7 y 11 dígitos numéricos" inputmode="numeric" oninput="this.value = this.value.replace(/[^0-9]/g, '')" required>
                </div>
                ...
                <!-- KM = Botón para mostrar la sección de cambio de contraseña -->
                ...
                <!-- KM = Sección oculta de contraseña -->
                ...
                <div class="campo">
                    ...
                    <div id="previewImagenSeleccionada">
                        <img src="../../../iconos/iconos_perfil/<?= htmlspecialchars($foto) ?>" alt="Foto actual" id="imagenActual" class="preview-foto">
                    </div>
                ...
                <a class="btn-glow" href="inicio_empleado_enfermero.php">Volver</a>
            </form>
        </section>
    </main>

    <!-- KM = Modal para selección de imagen de perfil -->
    <div id="modalImagen" class="modal" style="display: none;">
        <div class="modal-contenido">
            ...
            <div class="imagenes-opciones">
                <img src="../../../iconos/iconos_perfil/icono_enfer_1.png" onclick="seleccionarImagen(this, 'icono_enfer_1.png')">
                <img src="../../../iconos/iconos_perfil/icono_enfer_2.png" onclick="seleccionarImagen(this, 'icono_enfer_2.png')">
                <img src="../../../iconos/iconos_perfil/icono_enfer_3.png" onclick="seleccionarImagen(this, 'icono_enfer_3.png')">
            </div>
            <button type="button" class="boton-mai" onclick="confirmarImagen()">Aceptar</button>
        </div>
    </div>

    <!-- KM = Script para gestionar edición de perfil -->
    <script src="../../../java_script/pagina_empleado/editar_persona_apoyo.js"></script>
</body>
