<?php
// KM = Edición de persona de apoyo (consultor legal)
session_start();
...
function mostrarError($mensaje)
{
    ...
    header("Location: /Proyecto_real_v1/Proyecto_real/html/pagina_empleado/empleado_consultor/editar_consultor.php");
    exit();
}
...
// KM = Validar correo único (excepto para el consultor actual)
...
if ($stmt->execute()) {
    ...
    header("Location: /Proyecto_real_v1/Proyecto_real/html/pagina_empleado/empleado_consultor/editar_consultor.php?exito=Perfil actualizado");
    exit();
} else {
