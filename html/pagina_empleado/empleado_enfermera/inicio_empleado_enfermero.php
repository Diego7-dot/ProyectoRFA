...
<body>
  ...
  <section class="bienvenido">
    ...
    <p>
      Recuerda que <?= ($genero === 'F') ? 'la enfermera' : (($genero === 'M') ? 'el enfermero' : 'la persona enfermera') ?>
      cumple una labor esencial en el cuidado físico y el seguimiento de la salud de nuestras usuarias. Tu compromiso y profesionalismo hacen la diferencia.
    </p>
  </section>
