<!-- KM = Editar persona de apoyo (asesor) -->
...
<body>
    ...
    <main class="contenedor-editar">
        <section class="panel-editar">
            ...
            <form id="formEditar" action="../../../src/auth/editar_persona_asesor.php" method="POST" enctype="multipart/form-data">
                ...
                <a class="btn-glow" href="inicio_empleado_asesor.php">Volver</a>
            </form>
        </section>
    </main>
    ...
    <div id="modalImagen" class="modal" style="display: none;">
        <div class="modal-contenido">
            ...
            <div class="imagenes-opciones">
                <img src="../../../iconos/iconos_perfil/icono_asesor_1.png" onclick="seleccionarImagen(this, 'icono_asesor_1.png')">
                <img src="../../../iconos/iconos_perfil/icono_asesor_2.png" onclick="seleccionarImagen(this, 'icono_asesor_2.png')">
                <img src="../../../iconos/iconos_perfil/icono_asesor_3.png" onclick="seleccionarImagen(this, 'icono_asesor_3.png')">
            </div>
