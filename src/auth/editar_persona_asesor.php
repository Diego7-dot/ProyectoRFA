<?php
// KM = Edición de persona de apoyo (asesor)
session_start();
...
// KM = Funcíon para mostrar error y redirigir
function mostrarError($mensaje)
{
    $_SESSION["error_edicion"] = $mensaje;
    header("Location: /Proyecto_real_v1/Proyecto_real/html/pagina_empleado/empleado_asesor/editar_asesor.php");
    exit();
}
...
if ($stmt->execute()) {
    ...
    header("Location: /Proyecto_real_v1/Proyecto_real/html/pagina_empleado/empleado_asesor/editar_asesor.php?exito=Perfil actualizado");
    exit();
} else {
