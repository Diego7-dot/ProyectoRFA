...
// KM = Obtener documento desde el login
$documento = $_SESSION['docApo'] ?? '';

// KM = Si no se encuentra una sesion, devuelve al index principal
if (!$documento) {
...
<head>
    ...
    <!-- KM = Estilos CSS -->
    <link href="../../../css/pagina_empleado/empleado_asesor/estilo_disponibilidad_asesor.css" rel="stylesheet">
</head>
...
<body>
    ...
    <div id="contenido-disponibilidad"></div>

    <input type="hidden" id="docApo" value="<?= htmlspecialchars($documento) ?>">

    <script src="../../../java_script/pagina_empleado/empleado_asesor/disponibilidad_asesor.js"></script>
