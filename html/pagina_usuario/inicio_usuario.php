<!--***********************************************************************-->
<!-- KM = Inicio de usuario: Red femenina de apoyo-->
<!--***********************************************************************-->
...
<head>
  ...
  <!-- KM = Estilos CSS -->
  <link href="../../css/pagina_usuario/estilo_inicio_usuario.css" rel="stylesheet">
</head>
...
<body>
  ...
  <section class="bienvenido">
    <span class="bienvenida_user_limitada">
      <h2 class="nombre-usuario_bi"><?= $titulo ?> <?= htmlspecialchars($nombre) ?></h2>
    </span>
    <p>Recuerde que usted es alguien muy importante para nosotros y todo nuestro equipo estará para apoyarl<?= ($genero === 'F') ? 'a' : (($genero === 'M') ? 'o' : 'e') ?>!</p>
  </section>

  <script src="../../java_script/pagina_usuario/usuario_inicio.js"></script>
</body>
