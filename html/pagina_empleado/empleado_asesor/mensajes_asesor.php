...
<head>
    ...
    <!-- KM = Estilos CSS -->
    <link href="../../../css/pagina_empleado/empleado_asesor/estilo_mensaje_asesor.css" rel="stylesheet">
</head>
...
<body>
    ...
    <div class="contenedor-general">
        <div class="chat-wrapper">
            ...
            <!-- KM = Lista de usuarios conectados -->
            <div class="chat-sidebar" id="sidebar-conversaciones">
                <ul id="lista-salas"><!-- JS inserta hasta 10 li --></ul>
            </div>

            <!-- KM = Contenedor del chat -->
            <div class="chat-main oculto" id="chat-main-asesor">
            ...
            <!-- KM = Datos ocultos -->
            <input type="hidden" id="docApo" value="<?= $_SESSION['docApo'] ?>">
            <input type="hidden" id="room-id" value="">
            <input type="hidden" id="corUsu" value="">
        </div>
    </div>

    <script src="../../../java_script/pagina_empleado/empleado_asesor/mensaje_asesor.js"></script>
</body>
