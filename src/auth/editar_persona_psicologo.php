<?php
// KM = Edición de persona de apoyo (psicólogo)
session_start();
...
function mostrarError($mensaje)
{
    ...
    header("Location: /Proyecto_real_v1/Proyecto_real/html/pagina_empleado/empleado_psicologo/editar_psicologo.php");
    exit();
}
...
if ($stmt->execute()) {
    ...
    header("Location: /Proyecto_real_v1/Proyecto_real/html/pagina_empleado/empleado_psicologo/editar_psicologo.php?exito=Perfil actualizado");
    exit();
} else {
