<!--KM = Ingresar nueva contraseña - Persona de Apoyo -->
<?php session_start(); ?>
...
<body>
    ...
    <!--KM = Formulario para nueva contraseña -->
    <form action="../../src/auth/recuperar_con/guardar_contra_apoyo.php" method="POST" id="form-restablecer">
        <h2>Ingresa tu nueva contraseña</h2>

        <label for="psw1">Nueva contraseña:</label>
        <div class="input-icon">
            <input class="controls" type="password" name="nuevaPsw" id="psw1" ...>
